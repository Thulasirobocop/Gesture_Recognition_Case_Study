...
Using CNN/RNN and pretrained models predict the gesture from the video frames belonging to one of the 5 classes
...
The Details of the Process and the model creation are given in the writeup PDF.
